...
function ProtectPANandCVV(e, t, r) {
    var a = n.distill(e),
        i = n.distill(t);
...
export function encryptWalmartCreditCard(PIEL, PIEE, PIEK, PIEKEY, PIEPHASE, CCNUM, CVV) {
    // var PIE = {};
    ...
    var firstRound = ProtectPANandCVV(CCNUM, CVV, !0);
    return firstRound;
}

export function encryptWalmartPayment(PIEL, PIEE, PIEK, PIEKEY, PIEPHASE, CVV) {
    // var PIE = {};
    ...
    var firstRound = ProtectPANandCVV('4111111111111111', CVV, !0);
    return firstRound;
}
