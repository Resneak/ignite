...
function executeChallenge(session) {
    ...
    let input = '0b3e34dd-8e0d-4258-b1ea-364081666a38';
    let zeroCount = 4;
    session.solution = run(input, zeroCount);
}

let object = {
    "userId": "1aff1916-3f91-45dd-afb2-cf41ece3097e",
    "meta": "",
    "sessionId": "85f90a27-a14b-4dfd-b8b7-6b68d1bd62c4",
    "solution": {
      "postfix": 99803,
      "hash": "0000910f8e17278a6929c54a5095b382a77ce5f631ea8a122516bdcd050e6bf4"
    },
    "tags": [
      "powTag-CustomerId:footlocker",
      "powTag-EventId:prod715dunk",
      "powTag-UserId:1aff1916-3f91-45dd-afb2-cf41ece3097e"
    ],
    "stats": {
      "duration": 1945,
      "tries": 1,
    ...
    "parameters": {
      "input": "0b3e34dd-8e0d-4258-b1ea-364081666a38",
      "zeroCount": 4
    }
}
